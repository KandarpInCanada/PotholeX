  ...
  try {
    ...
    for (let i = 0; i < images.length; i++) {
      try {
        ...
        // Use Supabase REST API directly for more reliable uploads
        const supabaseUrl = "https://wrvxaeovzemcwbkdifkl.supabase.co"
        const supabaseKey =
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndydnhhZW92emVtY3dia2RpZmtsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDA3OTQxMzMsImV4cCI6MjA1NjM3MDEzM30.ew524l0WIM4_81YtRz-Hmyyx_FWU0-0U2u3CCKyErS0"
        const bucketName = "pothole-images"
